...
parser.add_argument('--train', help='training file', type=str, dest='trainFile')
parser.add_argument('--test', help='test file', type=str, dest='testFile')
parser.add_argument('--vector', help='vector file', type=str, dest='vectorFile')
parser.add_argument('--saveModel', help='save model file', type=str, dest='saveModel', default='nn_model')
parser.add_argument('--output', help='output file name', type=str, dest='outputFile', default='predict_nn.txt')
...
word_size = 10 #とりあえず，分かち書きした文字数は最大で10単語になる仮定
answer_dic = {}
